就労継続支援B型事業所で作業を実施している利用者向けポートフォリオを試しに設置してみました
<br><br>

作業者（利用者）が就職活動するためのポートフォリオを作成する場合
<br>
事業所としての基礎的な書式が無かったので準備しておくことが必要と思い検討を進めてみました
<br><br>

まず試してみたのは、無料配布されているポートフォリオテンプレート
<br>
特定の環境での構築に依存しないようにしたいので
<br>
ファイルのみを配布しているところを探しました
<br><br>

今回、試したのはこちら↓
<br>
「未経験からWebデザイナーへ！」さんが配布されている
<br>
【無料】ポートフォリオHTMLテンプレート（ベーシック）
<br>
https://webdesigner-go.com/template/portfolio-02/

公開を意識して実際に「GitHub Pages」のウェブサーバーに設定しました
<br>
そのまま設置せずに少しだけカスタマイズしてみました
<br><br>

シングルページWebサイト（ワンページサイト）構成なので
<br>
各コンテンツの別ページ（リンク先）にもヘッダーナビのメニューが必要になります
<br>
主に［Works］セクション内のリンクはページは遷移しないように変更しました
<br>
具体的には Fancybox(jQueryプラグイン) を使って他ページを iframe化になります
<br><br>
...
試しに設置したみただけですが
<br>
今後、希望者がいたらこのテンプレートも選択肢として使わせていただく予定です
<br><br>
